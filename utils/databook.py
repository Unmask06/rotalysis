...
class Databook:
    def __init__(self, databook_path: str = "utils/Databook.xlsx"):
        """
        Initializes the Databook class by setting the path to the databook and verifying its existence.
    ...
    def get_dataframe(
        ...
        :param cell_range: The cell range (e.g., "A1") to start from. Expands to include the full range automatically.
